...
public class TTSServiceImpl implements NaverService {
	...
	public String test(String txtfile, String speaker) {
		...
		try {
			...
			// // 13자
			FileReader fr = new FileReader(MyNaverInform.path + txtfile);
			sc = new Scanner(fr);
			String text = "";
			...
			// post request
			String postParams = "speaker=" + speaker
					+ "&emotion=2&emotion-strength=2&volume=0&speed=0&pitch=0&format=mp3&text=" + text;
